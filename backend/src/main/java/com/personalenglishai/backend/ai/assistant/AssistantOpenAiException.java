...
public class AssistantOpenAiException extends RuntimeException {
    ...
    public AssistantOpenAiException(Integer statusCode,
                                    String errorCode,
                                    String errorParam,
                                    String responseBody,
                                    Throwable cause) {
    ...
    private static String buildMessage(Integer statusCode, String errorCode, String errorParam) {
        StringBuilder sb = new StringBuilder("OpenAI assistant response failed");
        if (statusCode != null) {
