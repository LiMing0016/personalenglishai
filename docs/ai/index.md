...
AI 文档记录评分、语法检查、Prompt 组装、助手路由、输出契约和 agent 工作流。

## 当前文档

- [评分方法](./scoring-methodology.md)
- [评分规则](./scoring-rules/)
- [语法检查](./grammar-check.md)
- [润色能力](./polish-feature.md)
- [学习助手 Agent 编排架构](../agent/学习助手Agent编排架构.md)
