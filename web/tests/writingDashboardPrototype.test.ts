...
assert.ok(overviewCardSource.includes('buildWeekLabels'), 'overview chart should build week buckets for medium ranges')
...
assert.ok(overviewCardSource.includes('formatMonthLabel'), 'overview chart should format monthly labels for long ranges')
...
assert.ok(writingPageSource.includes('formatScatterMonth'), 'essay landing scatter chart should group essays by scored month')
